...
|-----|----------|---------|------|
| Anthropic Claude | [anthropic-claude.md](anthropic-claude.md) | LLM reasoning, extraction, tool use | x-api-key header |
...
| Strateos | [strateos.md](strateos.md) | Cloud lab experiment submission (Autoprotocol) | Email + token |
...
| API | Doc File | Purpose | Auth |
|-----|----------|---------|------|
| STRING Database | [string-db.md](string-db.md) | Protein-protein interaction network | None (public) |
| KEGG REST | [kegg-rest.md](kegg-rest.md) | Pathway/gene/compound cross-references | None (public) |
| PubChem PUG REST | [pubchem.md](pubchem.md) | Compound properties, structure search | None (public) |
